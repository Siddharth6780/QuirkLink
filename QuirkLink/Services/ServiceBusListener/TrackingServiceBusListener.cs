...
{
    public class TrackingServiceBusListener : BackgroundService
    {
        ...
        public TrackingServiceBusListener(IServiceBusListenerClient serviceBusListenerClient, ServiceBusClient serviceBusClient, string queueName)
        {
        ...
        public async Task MessageHandler(ProcessMessageEventArgs args)
        {
            try
            {
                ...
                TrackingQueueServiceBusMessage message = args.Message.Body.ToObjectFromJson<TrackingQueueServiceBusMessage>();

                // Process the message.
                _ = message ?? throw new ArgumentNullException(nameof(message));
                await this.serviceBusListenerClient.ProcessLinkAccessMessageAsync(message, CancellationToken.None);
